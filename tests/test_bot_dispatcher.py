...
class BotDispatcherTests(unittest.TestCase):
    ...
    def test_dispatcher_routes_trade_commands(self) -> None:
        ...
        self.assertIn("Approval processed for proposal_dispatch", dispatcher.dispatch("trade_approve_only proposal proposal_dispatch").text)
        self.assertIn("Report for proposal_dispatch", dispatcher.dispatch("/trade_report proposal_dispatch").text)
        self.assertIn("Report for proposal_dispatch", dispatcher.dispatch("trade_report proposal proposal_dispatch").text)
