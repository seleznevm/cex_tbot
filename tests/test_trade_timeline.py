...
class TradeTimelineTests(unittest.TestCase):
    def test_builds_combined_timeline_view(self) -> None:
        ...
        orchestrator.process_market_tick("proposal_1", result.position, MarketSnapshot("BTC_USDT", 101.0, 101.1, 101.0, 1_000_000, 500_000, 1.0, 100_000))
