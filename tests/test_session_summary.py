...
from cex_tbot.execution import ExecutionOrchestrator, InMemoryExecutionJournal, InMemoryExecutionStateStore
...
class SessionSummaryTests(unittest.TestCase):
    def test_builds_session_summary(self) -> None:
        session = TradeSessionStore(
            operator_transcript=InMemoryOperatorTranscript(),
        ...
        self.assertEqual(summary.operator_commands, 1)
        self.assertGreaterEqual(summary.execution_events, 3)
